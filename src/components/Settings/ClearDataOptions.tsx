	...
	return (
		<div className="p-6">
			...
			<div className="flex items-center justify-between p-4 border border-red-200 bg-red-50 rounded-lg">
				<div>
					...
					<p className="text-sm text-red-600 mt-1">
						{__(
							'This will permanently delete all saved tables, settings, styles, and configurations — restoring the plugin to its freshly installed state.',
							'productbay'
						)}
					</p>
				</div>
			...
			<Modal
				...
				primaryButton={{
					text: saving
						? __('Resetting...', 'productbay')
						: __('Yes, Reset Everything', 'productbay'),
					onClick: handleReset,
					variant: 'danger',
			...
			>
				<div className="space-y-4">
					...
					<p className="text-gray-600 m-0 text-sm">
						{__(
							'This will delete all your saved tables and reset every setting to factory defaults. The plugin will return to its freshly installed state. This cannot be undone.',
							'productbay'
						)}
					</p>
					<div className="pt-2">
