                ...
                {isConfirming && (
                    ...
                    >
                        <div className="bg-white border border-gray-200 rounded-lg shadow-xl p-1.5 flex items-center gap-1 min-w-max">
                            {confirmMessage && (
                                <span className="text-xs font-medium px-2 text-gray-700">{confirmMessage}</span>
                            )}
                            ...
                            <div className="flex items-center border border-gray-200 rounded-md">
                                <button
                                    ...
                                    title="Confirm"
                                >
                                    {confirmIcon || <CheckIcon className="h-4 w-4 font-bold" strokeWidth={2.5} />}
                                </button>
                                ...
                                <button
                                    ...
                                    title="Cancel"
                                >
                                    {cancelIcon || <XIcon className="h-4 w-4 font-bold" strokeWidth={2.5} />}
                                </button>
                            </div>
                        </div>
                        ...
                        <div className={cn(
                            ...
                            popoverPosition === 'top' ? 'mt-[1px]' :
                                popoverPosition === 'bottom' ? 'mb-[1px]' :
                                    popoverPosition === 'left' ? 'ml-[1px]' : 'mr-[1px]'
                        )} />
