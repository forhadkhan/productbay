...
export const EditableText = ({
	...
	return (
		<div>
			...
			<div className={cn('group flex items-center gap-2', className, classNames?.root)}>
				...
				{!disabled && (
					...
					>
						{isEditing ? (
							<CheckIcon className={cn('size-5', classNames?.icon)} />
						) : (
							<PenLineIcon className={cn('size-5', classNames?.icon)} />
						)}
					</button>
				)}
			</div>
