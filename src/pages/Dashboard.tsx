				...
				<div className="bg-white p-6 rounded-xl flex flex-col md:flex-row items-center gap-6 mb-6 shadow-sm border border-orange-500">
					...
					<div className="flex-1 text-center md:text-left">
						...
						<p className="text-gray-600 text-sm max-w-2xl">
							<strong>ProductBay</strong> requires published{ ' ' }
							<strong>WooCommerce</strong> products to build your
							tables.
							<br />
							We couldn't find any products in your WooCommerce
							store yet.
							<br />
							Create your first product to start building
							high-converting tables.
						</p>
					</div>
			...
			{ isLoading ? (
				...
				<div className="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center animate-fade-in">
					...
					<h2 className="text-2xl font-bold text-gray-900 mb-2">
						Welcome to ProductBay
					</h2>
					<p className="text-gray-500 max-w-md mx-auto mb-8">
						Get started by creating your first product table. It
						takes less than 2 minutes to significantly improve your
						conversion rate.
					</p>
					<Button
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				...
				<div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
					...
					<p className="text-sm text-gray-500 mb-4">
						Watch our quick video guide or read the documentation to
						master ProductBay in minutes.
					</p>
				...
				<div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
					...
					<p className="text-sm text-gray-500 mb-4">
						Import or export your table configurations for backup or
						migration.
					</p>
				...
				<div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
					...
					<p className="text-sm text-gray-500 mb-4">
						Need help? Have a feature request? We'd love to hear
						from you.
					</p>
					<Link
						to="/help"
