...
const Settings = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <h1 className="text-2xl font-bold text-gray-800">Plugin Settings</h1>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 divide-y divide-gray-200">
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Default Products Per Page</label>
                            <input
                                type="number"
                                value={settings.products_per_page || 10}
                                onChange={(e) => setSettings({ ...settings, products_per_page: parseInt(e.target.value) })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-md"
                            />
                        </div>
                    </div>
                ...
                <div className="p-6">
                    <h3 className="text-lg font-medium text-red-600 mb-4">Uninstall Options</h3>
                    <div className="flex items-center justify-between">
                        <div>
                            <span className="font-medium text-gray-800">Delete Data on Uninstall</span>
                            <p className="text-sm text-gray-500">Enable this to wipe all tables and settings when deleting the plugin.</p>
                        </div>
                        <input
                            type="checkbox"
