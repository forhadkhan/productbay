...
const Design = () => {
    ...
    if (loading) return <div className="p-8 text-center">Loading design settings...</div>;

    const design = settings.design || { header_bg: '#f3f4f6', border_color: '#e5e7eb' };

    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <h1 className="text-2xl font-bold text-gray-800">Global Design Defaults</h1>
            <p className="text-gray-500">These settings apply to all new tables. You can override them in individual table settings.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                />
                                <span className="text-gray-500 font-mono text-sm">{design.header_bg}</span>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="flex items-center gap-3">
                                <input
                                    ...
                                    className="h-10 w-20 p-1 rounded border border-gray-300 cursor-pointer"
                                />
                                <span className="text-gray-500 font-mono text-sm">{design.border_color}</span>
                            </div>
                        </div>
                    </div>
                </div>
