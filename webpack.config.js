 ...
 *
 * Source Code (Root): ${repoUrl}/tree/v${version}/
 * Source Code (Admin): ${repoUrl}/tree/v${version}/src
 *
...
module.exports = {
	...
	output: {
		...defaults.output,
		path: path.resolve(__dirname), // Root of plugin, so blocks/ goes to root
		filename: (pathData) => {
			const name = pathData.chunk.name;
			if (name === 'admin') {
				return 'assets/js/admin.js';
			}
			return `${name}.js`; // e.g. blocks/product-table/index.js
		},
		clean: false, // Don't wipe the folders automatically here
	},
