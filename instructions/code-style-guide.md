...
## Documentation:  
- Document all classes and methods with proper PHPDoc/JSDoc blocks.  
- Include the `@since` tag in all documentation blocks (e.g., `@since 1.0.0`) to track versioning, following WordPress standards.
...
- `bun run release` — Package plugin ZIP
...
- `assets/` — Compiled JS/CSS output and static files 